...
- Al revisar nuevas fuentes con datos de cantineras, omitir datos que solo repitan una cantinera ya confirmada en `data/cantineras.json`. Integrar solo cantineras nuevas, correcciones claras, datos pendientes de confirmar o fuentes que resuelvan una duda existente.
