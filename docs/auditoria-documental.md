...
| `El Irunes` | 75 PDF | revisado hasta varios numeros, no todos con el mismo nivel; nums. 39-40 OCR completos registrados | alta | Fuente muy rica en entrevistas, curiosidades, mandos, musica, cantineras y memoria de companias. Hay que asegurar que los 75 numeros tengan salida documentada. El num. 39 se proceso completo por OCR y no aporto dato nuevo integrable; el num. 40 aporto datos para Bidasoa, Buenos Amigos, Real Union y Uranzu. |
